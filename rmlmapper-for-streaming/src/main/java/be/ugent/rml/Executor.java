...
public class Executor {
    ...
    public QuadStore execute(List<Term> triplesMaps, boolean removeDuplicates, MetadataGenerator metadataGenerator) throws Exception {
        System.out.println("execute depricated");
        HashMap<Term, QuadStore> result = this.executeV5(triplesMaps, removeDuplicates, metadataGenerator, null);
    ...
    public QuadStore executeWithFunction(List<Term> triplesMaps, boolean removeDuplicates, BiConsumer<ProvenancedTerm, PredicateObjectGraph> pogFunction) throws Exception {
        System.out.println("executeWithFunction depricated");
        HashMap<Term, QuadStore> result = this.executeWithFunctionV5(triplesMaps, removeDuplicates, pogFunction, null);
        return result.get(new NamedNode("rmlmapper://legacy.store"));
    }
    ...
    public QuadStore execute(List<Term> triplesMaps) throws Exception {
        System.out.println("execute depricated");
        HashMap<Term, QuadStore> result = this.executeV5(triplesMaps, false, null, null);
        return result.get(new NamedNode("rmlmapper://legacy.store"));
    }
     ...
     */
    public HashMap<Term, QuadStore> executeV5(List<Term> triplesMaps, boolean removeDuplicates, MetadataGenerator metadataGenerator, String record_str) throws Exception {
        ...
        return executeWithFunctionV5(triplesMaps, removeDuplicates, pogFunction, record_str);
    }
    ...
    public HashMap<Term, QuadStore> executeWithFunctionV5(List<Term> triplesMaps, boolean removeDuplicates, BiConsumer<ProvenancedTerm, PredicateObjectGraph> pogFunction, String record_str) throws Exception {
        ...
        for (Term triplesMap : triplesMaps) {
            ...
            List<Record> records = this.getRecords(triplesMap, record_str);
    ...
    public HashMap<Term, QuadStore> executeV5(List<Term> triplesMaps) throws Exception {
        return this.executeV5(triplesMaps, false, null, null);
    }
    ...
    private List<Record> getRecords(Term triplesMap, String record_str) throws Exception {
        if (!this.recordsHolders.containsKey(triplesMap)) {
            this.recordsHolders.put(triplesMap, this.recordsFactory.createRecords(triplesMap, this.rmlStore, record_str));
        }
